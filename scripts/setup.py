...
if 'tensorboard' in sys.argv[1:]:
	subprocess.call(['chmod', '+x', '/content/Neural_Networks-101-demo/scripts/run_tensorboard.sh'])
	subprocess.call(['/content/Neural_Networks-101-demo/scripts/run_tensorboard.sh'])
